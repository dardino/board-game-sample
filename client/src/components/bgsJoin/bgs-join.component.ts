...
export class BgsJoinComponent extends HTMLElement {
  ...
  public static register() {
    customElements.define(BgsJoinComponent.tagName, BgsJoinComponent);
  }

  get #elNotRegistered() { return this.querySelector<HTMLDivElement>("#notRegistered")!; };
  get #elRegistered() { return this.querySelector<HTMLDivElement>("#registered")!; };
  get #elInput() { return this.querySelector<HTMLInputElement>("input")!; };
  get #elNickname() { return this.querySelector<HTMLSpanElement>("#nickname")!; };
  get #elRegisterForm() { return this.querySelector<HTMLFormElement>("#registerForm")!; };
  get #elLogout() { return this.querySelector<HTMLButtonElement>("#logout")!; };
  get #elErrorMessage() { return this.querySelector<HTMLSpanElement>("#errorMessage")!; }

  #cookie: Record<string, string> = {};
  #imRegistered: boolean = false;
  #playerInfo: PlayerDto = { id: 0, isPlaying: false, nickname: "" };
  ...
  #attachEvents() {
    this.#elRegisterForm.addEventListener("submit", this.#submit);
    this.#elLogout.addEventListener("click", this.#clickLogout);
  }
  #detachEvents() {
    this.#elRegisterForm.removeEventListener("submit", this.#submit);
    this.#elLogout.removeEventListener("click", this.#clickLogout);
  }
