...
describe(
  ...
  () => {
    ...
    describe("GameOneMatchManager", () => {
      ...
      it("GameOneMatchManager - Setup with autoplay shold stop on CharacterSelection", () => {
      ...
      it("GameOneMatchManager - after CharacterSelection should stop after Player Awake", () => {
