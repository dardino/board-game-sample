...
describe("GameOne - Rules", () => {
  describe("Setup Phase", () => {
    ...
    it("Action PlaceFirstTile", () => {
      ...
      expect(newState.onboardTiles[0].playersIn).toStrictEqual([1, 2, 3, 4]);
    ...
    it("Action CharacterSelection", () => {
      ...
      const newState = GameOneMatchManager(initialGameState, {
        ...
        selectedCharacters: [
          { characterId: 1, characterName: "Giocatore 1", playerId: 1 },
          { characterId: 2, characterName: "Giocatore 2", playerId: 2 },
          { characterId: 3, characterName: "Giocatore 3", playerId: 3 },
          { characterId: 4, characterName: "Giocatore 4", playerId: 4 },
        ],
      });
  ...
  describe("Player Turn", () => {
    const mockInitialGameState = () => {
      ...
      initialGameState.tilesDeck = {
        ...
        L3: OTHER_TILES.filter((tile) => tile.ring === 3).concat([
          BOSS_TILES[0],
        ]),
      };
