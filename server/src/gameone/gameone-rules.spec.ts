  ...
  () => {
    ...
    describe(
      ...
      () => {
        ...
        it(
          "Action SetPlayers as first action",
          () => {
    ...
    describe(
      ...
      () => {
        ...
        test(
          "GameOneMatchManager - Setup with autoplay shold stop on CharacterSelection",
          () => {
        ...
        test(
          "GameOneMatchManager - after CharacterSelection should stop after Player Awake",
          () => {
