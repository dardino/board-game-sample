  ...
  () => {
    ...
    describe(
      ...
      () => {
         ...
         */
        it(
          "should verify that the total number of players is increased by 1 when a new player is added",
          async () => {
    ...
    describe(
      ...
      () => {
         ...
         */
        it(
          "should return the player with the correct nickname",
          async () => {
         ...
         */
        it(
          "should throw an error if the player with the given nickname does not exist",
          async () => {
    ...
    describe(
      ...
      () => {
         ...
         */
        it(
          "should remove the player with the given nickname",
          async () => {
